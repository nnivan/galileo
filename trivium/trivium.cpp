...
string cipher_trivium(string plaintext){

    string ciphertext = plaintext;

    string keystr = read_file("trivium_key.txt");
    string ivstr = read_file("trivium_iv.txt");
...
int main ()
{
    cout<<cipher_trivium(cipher_trivium("Hello, my friend!\n"));
    return 0;
}
